      ...
      <div style={{ width: '1270px', margin: '0 auto', height: '1270px'}}>
        ...
        <WrapperHeaderUser>
          ...
          <WrapperInfoUser>
            ...
            <WrapperContentInfo>
              ...
              <div className='delivery-fee'><span>Phí giao hàng: </span> 0</div>
            </WrapperContentInfo>
          </WrapperInfoUser>
          <WrapperInfoUser>
        ...
        <WrapperStyleContent >
          <div style={{flex:1,display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
            <div style={{width: '670px', paddingLeft:"380px"}}>Sản phẩm</div>
          ...
          {data?.orderItems?.map((order) => {
            return (
              <WrapperProduct >
                <WrapperNameProduct style={{paddingLeft:"380px"}}>
                  <img src={order?.image} 
                    style={{
                      width: '70px', 
                      height: '70px', 
